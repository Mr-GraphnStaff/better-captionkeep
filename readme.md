...
Target store: **Microsoft Edge Add-ons only**. Version 4.6 is live, with its refreshed listing subject to Microsoft review. Version 4.7 is feature-complete and QA/UAT-approved; it is staged for a separate Store submission after the current 4.6 listing review clears. The [privacy policy](PRIVACY.md) is published. This repository does not imply Store approval for 4.7 until Microsoft completes certification.
